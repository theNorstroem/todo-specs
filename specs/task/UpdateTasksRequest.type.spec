name: UpdateTasksRequest
type: UpdateTasksRequest
description: request message for UpdateTasks
__proto:
    package: task
...
fields:
    body:
        ...
        meta:
            default: ""
            hint: ""
            label: task.UpdateTasksRequest.body.label
            options:
                flags: []
                list: []
            readonly: false
    ...
    tsk:
        ...
        meta:
            default: ""
            hint: ""
            label: task.UpdateTasksRequest.tsk.label
            options:
                flags: []
                list: []
            readonly: false
    ...
    update_mask:
        ...
        meta:
            default: ""
            hint: ""
            label: task.UpdateTasksRequest.update_mask.label
            options:
                flags: []
                list: []
            readonly: false
